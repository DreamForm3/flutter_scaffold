...
import 'custom_form_builder_field_option.dart';



/// 拷贝了 flutter_form_builder: ^7.0.0 包里面的 FormBuilderChoiceChip 修改
/// A list of `Chip`s that acts like radio buttons
class CustomFormBuilderChoiceChip<T> extends FormBuilderField<T> {
  /// The list of items the user can select.
  final List<CustomFormBuilderFieldOption<T>> options;
      ...
      builder: (FormFieldState<T?> field) {
        ...
        return InputDecorator(
          ...
          child: Wrap(
            ...
            children: <Widget>[
              for (CustomFormBuilderFieldOption<T> option in options)
                ChoiceChip(
                  // 这里增加了 avatar
