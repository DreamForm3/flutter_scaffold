...
class _ChartsScreenState extends State with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: _getScrollContent(context)),
      ),
    );
  }

  List<Widget> _getScrollContent(BuildContext context) {
    List<Widget> list = [
      Row(
        children: [
          Text('日期:'),
      ...
      ClipRect(
        child: Align(
          ...
          heightFactor: _contentStep > 1 ? 1 : 0.5,
      ...
      list.addAll([
        Row(
          ...
          children: [
            ...
            //     // avatar: Icon(Icons.today),
            //     label:
            //         Text(_monthFormat.format(_dataSearchParam.currentDate)),
            //     onPressed: _showDatePickerDialog),
            // SizedBox(
            //   width: 16,
            // ),
